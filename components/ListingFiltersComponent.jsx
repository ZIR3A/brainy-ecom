...
const ListingFiltersComponent = memo(function ListingFiltersComponent(props) {
  return (
    <aside className="w-1/4 bg-white rounded-xl border border-graylight p-6">
      ...
      <div id="brands" className="space-y-2 mt-[10px]">
        <h3 className="font-semibold py-2">
          Brands <i class="fa-solid fa-chevron-up mt-1 float-end text-graylight" suppressHydrationWarning />
        </h3>
      ...
      <div id="brands" className="space-y-2 mt-[10px]">
        <h3 className="font-semibold py-2">
          Features <i class="fa-solid fa-chevron-up mt-1 float-end text-graylight" suppressHydrationWarning />
        </h3>
      ...
      <div id="price-range" className="space-y-2 mt-[10px]">
        <h3 className="font-semibold py-2">
          Price range <i class="fa-solid fa-chevron-up mt-1 float-end text-graylight" suppressHydrationWarning />
        </h3>
        <div className="mb-6">
        ...
        <div className="mt-3 flex gap-2 justify-between">
          <div>
            <span class="text-sm text-maingray block mb-1">Min</span>
            <BasicInput className="h-10 w-24 rounded-lg" placeHolder="0" min={0} />
          </div>
          <div>
            <span class="text-sm text-maingray block mb-1">Max</span>
            <BasicInput className="h-10 w-24 rounded-lg" placeHolder="99999" max={99999} />
          </div>
        </div>
        <button type="button" class="text-bluish hover:text-white border border-[#DEE2E7] hover:bg-[#0D6EFD] focus:ring-4 focus:outline-none focus:ring-[#DEE2E7] font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-full mt-3">
          Apply
        </button>
      </div>
      <div id="brands" className="space-y-2 mt-[10px]">
      ...
      <div id="brands" className="space-y-2 mt-[10px]">
        <h3 className="font-semibold py-2">
          Ratings <i class="fa-solid fa-chevron-up mt-1 float-end text-graylight" suppressHydrationWarning />
        </h3>
