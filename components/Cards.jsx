        ...
        <div className="flex">
          <div className="">
            ...
            <h3 className="flex items-center mt-3">
              <span className="font-semibold text-[20px]">${price}</span> <span className="ms-2 text-base text-semilight">${price}</span>
            </h3>
            <div className="flex items-center gap-x-[6px] mt-[4px]">
              ...
              <span className="text-lightbluish text-base">154 orders</span>
              <i className="fa-solid fa-circle text-[#C1D0E0] w-[6px] h-[6px]" suppressHydrationWarning />
              <span className={`${stock > 0 ? "text-[#4C8435]" : "text-red-500"} text-base`}>{stock > 0 ? "Free Shipping" : "Out Of Stock"}</span>
            </div>
            <div className="mt-3 mb-2">
              <p className="text-base text-semilight">{description}</p>
            </div>
            <Link className="text-[#0C0EFF] font-semibold" href="/">
              View details
            </Link>
          </div>
          <i class="fa-regular fa-heart absolute top-0 right-0 border border-graylight text-[#5676FF] p-2 rounded-[6px] float-end" suppressHydrationWarning />
        </div>
      </div>
    </div>
  );
