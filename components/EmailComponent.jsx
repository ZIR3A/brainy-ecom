    ...
    <div className="bg-[#DEE6EF]">
      <div className="max-w-7xl mx-auto py-10">
        <div className="text-center mb-[20px]">
          ...
          <span className="text-base text-semilight">Get daily news on upcoming offers from many suppliers all over the world</span>
        </div>
        <form className="flex items-center max-w-sm mx-auto">
          ...
          <div className="relative w-full">
            ...
            <input type="text" id="simple-search" className="h-11 block w-full ps-8 px-4 py-2 text-sm text-lightbluish border border-gray-300 rounded-xl bg-white focus:ring-[#5676FF] focus:border-[#5676FF] focus:outline-none" placeholder="Email" required />
          </div>
